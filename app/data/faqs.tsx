const faqs = [
	...
	},
	{
		...
		answer: "Yes, it is. There are no in-app purchases required. The App can be downloaded from the Google Play and Apple App stores.",
	},
	{
	...
	},
	{
		...
		answer:
			"The App does not cover the inner harbours at Christchurch and Poole, or any other beaches and public areas within Dorset or the UK. For now, the App is heavily reliant on visual observation from our BCP Seafront Ranger Team. ur team do not patrol these areas and so we cannot provide reliable congestion information at this time.",
	},
	{
	...
	{
		question: "How is data collected to update the beach congestion statuses?",
		answer:
			"The App is updated manually based upon weather patterns, footfall data and live CCTV footage in certain areas. The congestion status is determined by the Seafront Ranger Team using the data sources listed but mainly by live observations throughout the day.",
	},
	{
	...
	},
	{
		...
		answer:
			"When you tap on any highlighted section of the beach map, you will be presented with essential information on cycling restrictions, dog exercise and BBQ permissions. Information on whether there are public toilet facilities nearby is also displayed along with whether the beach is lifeguarded.",
	},
];
